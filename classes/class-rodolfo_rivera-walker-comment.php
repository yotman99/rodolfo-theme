			...
			<article id="div-comment-<?php comment_ID(); ?>" class="comment-body">
				<footer class="comment-meta">
					<div class="comment-author vcard">
						 ...
						 */
						if ( rodolfo_rivera_is_comment_by_post_author( $comment ) ) {
							printf( '<span class="post-author-badge" aria-hidden="true">%s</span>', rodolfo_rivera_get_icon_svg( 'check', 24 ) );
						}
					...
					<div class="comment-metadata">
						...
						<?php
							$edit_comment_icon = rodolfo_rivera_get_icon_svg( 'edit', 16 );
