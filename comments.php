...
<div id="comments" class="<?php echo comments_open() ? 'comments-area' : 'comments-area comments-closed'; ?>">
	...
	if ( have_comments() ) :
		...
		if ( comments_open() ) {
			rodolfo_rivera_comment_form( 'desc' );
		}
		...
		<ol class="comment-list">
			...
			wp_list_comments(
				array(
					...
					'avatar_size' => rodolfo_rivera_get_avatar_size(),
					'short_ping'  => true,
					'style'       => 'ol',
				)
			);
		...
		if ( have_comments() ) :
			$prev_icon     = rodolfo_rivera_get_icon_svg( 'chevron_left', 22 );
			$next_icon     = rodolfo_rivera_get_icon_svg( 'chevron_right', 22 );
		...
		if ( comments_open() && 'asc' === strtolower( get_option( 'comment_order', 'asc' ) ) ) :
			...
			<div class="comment-form-flex">
				...
				<?php rodolfo_rivera_comment_form( 'asc' ); ?>
		...
		// Show comment form.
		rodolfo_rivera_comment_form( true );
